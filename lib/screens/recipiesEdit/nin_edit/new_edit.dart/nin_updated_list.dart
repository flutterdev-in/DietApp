...
class NINupdatedList1 extends StatelessWidget {
  const NINupdatedList1({Key? key}) : super(key: key);
      ...
      body: PaginateFirestore(
        ...
        itemBuilder: (index, context, snapshot) {
          ...
          return GFListTile(
            ...
            //titleText: foodName,
            title: Row(
              children: [Text(foodName,textScaleFactor: 1.4,style: TextStyle(fontWeight: FontWeight.bold),), Text(uid)],
