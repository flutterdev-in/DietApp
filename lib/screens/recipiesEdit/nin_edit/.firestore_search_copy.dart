...
class FoodSearchForEditMeasure extends StatefulWidget {
  const FoodSearchForEditMeasure({Key? key}) : super(key: key);

  @override
  _FoodSearchForEditMeasureState createState() =>
      _FoodSearchForEditMeasureState();
}

class _FoodSearchForEditMeasureState extends State<FoodSearchForEditMeasure> {
